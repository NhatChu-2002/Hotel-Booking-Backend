...
public class PaymentService {
    public RefundResponse refund(String tranType, String orderId, Double price, String transDate, String user) throws IOException {
        ...
        Gson gson = new Gson();
        RefundResponse refundResponse = gson.fromJson(response.toString(), RefundResponse.class);
        return refundResponse;
    }
    public String getPay(Double price) throws UnsupportedEncodingException {
        String vnp_Version = "2.1.0";
