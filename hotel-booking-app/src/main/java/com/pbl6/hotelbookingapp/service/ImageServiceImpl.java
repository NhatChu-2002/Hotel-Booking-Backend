...
public class ImageServiceImpl implements ImageService {
    ...
    public ImageServiceImpl(HotelRepository hotelRepository, RoomTypeRepository roomTypeRepository, HotelImageRepository imageRepository, FirebaseStorageService firebaseStorageService, RoomImageRepository roomImageRepository) {
